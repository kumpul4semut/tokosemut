                ...
                <thead class=" text-primary">
                  <tr>
                    ...
                    <tr>
                        ...
                        <td><?= $r['price']; ?></td>
                        <td>
                            <a href="<?php echo base_url('admin/refund/acc/'.$r['id']) ?>" class="badge badge-success">acc</a>
                            <a href="<?php echo base_url('admin/refund/dany/'.$r['id']) ?>" class="badge badge-danger">dany</a>
                        </td>
                    </tr>
