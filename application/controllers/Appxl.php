 ...
 * @author kumpul4semut
 */
class Appxl extends CI_Controller
{
    /*
    * template load
    */
	...
	{
        parent::__construct();
        $this->load->library('Appxlcurl','','xl');
    }
	...
	public function index()
	{
		...
		$this->_template('public/req_otp_xl','public/_templates/footer-appxl',$data);
	...
	public function login()
	{
        ...
        if ($msisdn) {
            $this->_template('public/login_xl','public/_templates/footer-appxl',$data);
        }else{
            redirect('xl', 'refresh');
            exit;
        }
	...
	public function beli()
	{
        ...
        $this->_template('public/req_paket_xl','public/_templates/footer-appxl',$data);
	...
	public function req_paket()
	{
        ...
        if($reg == ""){
            ...
            $session = "E2VYr2Hxf+uOloL3aTxhx84fHwhJbNIq/Udlsk6MxknRx0euZv5TPN5ToOB2nIeV";
            $msisdn = 6287822618221;
            $serviceID = $this->service($reg);
            if ($serviceID == "diskon") {
                $exec = $this->xl->diskon($session);
                print_r($exec);
            }elseif($serviceID == "roda") {
                $exec = $this->xl->roda($msisdn,$session);
                print_r($exec);
            }else{
                try
                {
